locals {
  bio_v220_5_common_tags = merge(local.bio_v220_common_tags, {
    cis_section_id = "5"
  })
}

locals {
  bio_v220_5_1_common_tags = merge(local.bio_v220_5_common_tags, {
    cis_section_id = "5.1"
  })
  bio_v220_5_2_common_tags = merge(local.bio_v220_5_common_tags, {
    cis_section_id = "5.2"
  })
  bio_v220_5_3_common_tags = merge(local.bio_v220_5_common_tags, {
    cis_section_id = "5.3"
  })
}

benchmark "bio_v220_5" {
  title         = "5 Storage"
  documentation = file("./bio_v220/docs/bio_v220_5.md")
  children = [
    benchmark.bio_v220_5_1,
    benchmark.bio_v220_5_2,
    benchmark.bio_v220_5_3
  ]

  tags = merge(local.bio_v220_5_common_tags, {
    service = "OCI/Storage"
    type    = "Benchmark"
  })
}
...
benchmark "bio_v220_5_1" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_5_1.md")
  children = [
    control.bio_v220_5_1_1,
    control.bio_v220_5_1_2,
    control.bio_v220_5_1_3
  ]

  tags = merge(local.bio_v220_5_1_common_tags, {
...
control "bio_v220_5_1_1" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_5_1_1.md")
...
control "bio_v220_5_1_2" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_5_1_2.md")
...
control "bio_v220_5_1_3" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_5_1_3.md")
...
benchmark "bio_v220_5_2" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_5_2.md")
  children = [
    control.bio_v220_5_2_1,
    control.bio_v220_5_2_2
  ]

  tags = merge(local.bio_v220_5_2_common_tags, {
...
control "bio_v220_5_2_1" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_5_2_1.md")
...
control "bio_v220_5_2_2" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_5_2_2.md")
...
benchmark "bio_v220_5_3" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_5_3.md")
  children = [
    control.bio_v220_5_3_1
  ]

  tags = merge(local.bio_v220_5_3_common_tags, {
...
control "bio_v220_5_3_1" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_5_3_1.md")
