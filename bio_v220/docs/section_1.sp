locals {
  bio_v220_1_common_tags = merge(local.bio_v220_common_tags, {
    cis_section_id = "1"
  })
}
...
benchmark "bio_v220_1" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_1.md")
  children = [
    control.bio_v220_1_1,
    control.bio_v220_1_2,
    control.bio_v220_1_3,
    control.bio_v220_1_4,
    control.bio_v220_1_5,
    control.bio_v220_1_6,
    control.bio_v220_1_7,
    control.bio_v220_1_8,
    control.bio_v220_1_9,
    control.bio_v220_1_10,
    control.bio_v220_1_11,
    control.bio_v220_1_12,
    control.bio_v220_1_13,
    control.bio_v220_1_14,
    control.bio_v220_1_15
  ]

  tags = merge(local.bio_v220_1_common_tags, {
...
control "bio_v220_1_1" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_1_1.md")
...
control "bio_v220_1_2" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_1_2.md")
...
control "bio_v220_1_3" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_1_3.md")
...
control "bio_v220_1_4" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_1_4.md")
...
control "bio_v220_1_5" {
  ...
  query         = query.manual_control
  documentation = file("./bio_v220/docs/bio_v220_1_5.md")
...
control "bio_v220_1_6" {
  ...
  query         = query.manual_control
  documentation = file("./bio_v220/docs/bio_v220_1_6.md")
...
control "bio_v220_1_7" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_1_7.md")
...
control "bio_v220_1_8" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_1_8.md")
...
control "bio_v220_1_9" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_1_9.md")
...
control "bio_v220_1_10" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_1_10.md")
...
control "bio_v220_1_11" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_1_11.md")
...
control "bio_v220_1_12" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_1_12.md")
...
control "bio_v220_1_13" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_1_13.md")
...
control "bio_v220_1_14" {
  ...
  query         = query.manual_control
  documentation = file("./bio_v220/docs/bio_v220_1_14.md")
...
control "bio_v220_1_15" {
  ...
  query         = query.manual_control
  documentation = file("./bio_v220/docs/bio_v220_1_15.md")
