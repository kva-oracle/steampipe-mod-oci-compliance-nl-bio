locals {
  bio_v220_2_common_tags = merge(local.bio_v220_common_tags, {
    cis_section_id = "2"
  })
}
...
benchmark "bio_v220_2" {
  title         = "2 Networking"
  documentation = file("./bio_v220/docs/bio_v220_2.md")
  children = [
    control.bio_v220_2_1,
    control.bio_v220_2_2,
    control.bio_v220_2_3,
    control.bio_v220_2_4,
    control.bio_v220_2_5,
    control.bio_v220_2_6,
    control.bio_v220_2_7,
    control.bio_v220_2_8
  ]

  tags = merge(local.bio_v220_2_common_tags, {
    service = "OCI/VCN"
    type    = "Benchmark"
  })
}
...
control "bio_v220_2_1" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_2_1.md")
...
control "bio_v220_2_2" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_2_2.md")
...
control "bio_v220_2_3" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_2_3.md")
...
control "bio_v220_2_4" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_2_4.md")
...
control "bio_v220_2_5" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_2_5.md")
...
control "bio_v220_2_6" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_2_6.md")
...
control "bio_v220_2_7" {
  ...
  query         = query.manual_control
  documentation = file("./bio_v220/docs/bio_v220_2_7.md")
...
control "bio_v220_2_8" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_2_8.md")
