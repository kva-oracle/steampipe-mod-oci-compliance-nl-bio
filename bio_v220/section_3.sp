locals {
  bio_v220_3_common_tags = merge(local.bio_v220_common_tags, {
    cis_section_id = "3"
  })
}

benchmark "bio_v220_3" {
  title         = "3 Compute"
  documentation = file("./bio_v220/docs/bio_v220_3.md")
  children = [
    control.bio_v220_3_1,
    control.bio_v220_3_2,
    control.bio_v220_3_3
  ]

  tags = merge(local.bio_v220_3_common_tags, {
    type = "Benchmark"
  })
}
...
control "bio_v220_3_1" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_3_1.md")
...
control "bio_v220_3_2" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_3_2.md")
...
control "bio_v220_3_3" {
  ...
  documentation = file("./bio_v220/docs/bio_v220_3_3.md")
